package com.redhat.strombrau.tests;

import com.redhat.strombrau.core.registry.RegistryConnection;
import com.redhat.strombrau.core.registry.RegistryKeyListener;
import com.redhat.strombrau.core.registry.items.EventType;
import com.redhat.strombrau.core.registry.operations.CreateEventType;
import com.redhat.strombrau.core.registry.operations.ListEventTypes;
import com.redhat.strombrau.core.registry.operations.RemoveEventType;
...
public class EventTest {
    ...
    public void testListener() throws Exception {
        RegistryKeyListener<EventType> listener = connection2.addKeyListener("events", new RegistryKeyListener<EventType>() {
            @Override
